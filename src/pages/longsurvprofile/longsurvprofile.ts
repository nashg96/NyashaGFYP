...
/**
 * Generated class for the LongsurvprofilePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-longsurvprofile',
  templateUrl: 'longsurvprofile.html',
})
export class LongsurvprofilePage {
 ...
 @ViewChild('barCanvas') barCanvas;
  ...
  loadData(){
    this.getAllDocuments("LongtermSurvey"+ this.userId).then((e)=>{
      this.messages = e;
