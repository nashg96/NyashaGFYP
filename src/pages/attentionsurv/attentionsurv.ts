...
@IonicPage()
@Component({
  selector: 'page-attentionsurv',
  templateUrl: 'attentionsurv.html',
})
export class AttentionsurvPage {
date = new Date()
  ...
  loadData(){
    this.getAllDocuments("AttentionSurvey"+ this.userId).then((e)=>{
      this.messages = e;
  });
  }
...
addMessage(){
    this.addDocument("AttentionSurvey"+ this.userId, this.model).then(()=>{
